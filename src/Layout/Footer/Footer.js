...
function Footer() {
  ...
  return (
    <div className="bg-dry border-t-2 border-black rounded-2xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between">
          ...
          <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 md:col-start-6 xl:col-start-10">
            ...
            <p className="leading-7 text-sm text-border mt-3">
              <span>Lorem 196 Andrew Road, Suite 200</span>
              <br />
              <span>Tell: +1 234 567 8901</span>
              <br />
              <span>Email: info@hotmail.com</span>
            </p>
          </div>
        </div>
      </div>
